...
class History extends REST_Controller{
    ...
    public function push_post(){
        ...
        $location_data = array(
            ...
            'updated_at' => isset($data['updated_at']) ? date('Y-m-d h:i:s', strtotime($data['updated_at'])) : null,
        ...
        if(isset($data['connote']['history'])){
            foreach($data['connote']['history'] as $key){
                $history[] = array(
                    ...
                    'created_at' =>  date('Y-m-d h:i:s', strtotime($key['date'])),
                    'updated_at' => date('Y-m-d h:i:s', strtotime($key['date'])),
                    'content' => $key['content'],
                    'action' => $key['action'],
                    'id' => null,
                    'date' => date('Y-m-d h:i:s', strtotime($key['date'])),
